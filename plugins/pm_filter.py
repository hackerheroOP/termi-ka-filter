...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('CHANNEL', url='https://t.me/cloud_Station9')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('ɴᴇᴛᴡᴏʀᴋ', url='https://t.me/cloud_station9'),
        ...
        buttons = [[
           InlineKeyboardButton('ɴᴇᴛᴡᴏʀᴋ', url='https://t.me/cloud_station9'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/terminator094')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='aswin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
